...
NAEEM_void
NAEEM_test_assert (NAEEM_bool      /* Boolean value */, 
                   NAEEM_string    /* Failure message */);


NAEEM_void
NAEEM_test_assert_equal_uint32 (NAEEM_uint32      /* Expected value */,
                                NAEEM_uint32      /* Actual value */,
                                NAEEM_string      /* Failure message */);


NAEEM_void
NAEEM_test_assert_equal_byte_arrays (NAEEM_data      /* Expected data */, 
