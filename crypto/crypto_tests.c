...
NAEEM_test_DES() {
  ...
  NAEEM_result result = NAEEM_crypto__DES_cbc_encrypt(data, 9, cipher, &cipher_length, key);
  if (result != NAEEM_RESULT_SUCCESS) {
...
NAEEM_test_3DES() {
  ...
  NAEEM_result result = NAEEM_crypto__3DES_cbc_encrypt(data, 9, cipher, &cipher_length, key1, key2, key3);
  if (result != NAEEM_RESULT_SUCCESS) {
